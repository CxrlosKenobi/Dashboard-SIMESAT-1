...
def update_bmp(n):
    ...
    df0 = get_mpu9250_ac_data(total_time - 200, total_time)
    df1 = get_mpu9250_gy_data(total_time - 200, total_time)
    df2 = get_mpu9250_ma_data(total_time - 200, total_time)
    ...
    layout = dict(
        ...
        yaxis={
            "range": [
                min(min(df0["mpu9250_ac"]), min(df1['mpu9250_gy']), min(df2['mpu9250_ma'])),
                max(max(df0["mpu9250_ac"]), max(df1['mpu9250_gy']), max(df2['mpu9250_ma'])),
            ],
            "showgrid": True,
            "showline": True,
            "fixedrange": True,
